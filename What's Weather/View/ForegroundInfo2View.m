...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
       ...
       // self.viewArray=[[NSMutableArray alloc]initWithCapacity:4];
        ...
        UIView *animateView1=[[UIView alloc]initWithFrame:CGRectMake(0, 40, 320, 25)];
        UIView *animateView2=[[UIView alloc]initWithFrame:CGRectMake(0, 80, 320, 25)];
        [self.viewArray addObjectsFromArray:@[animateView1,animateView2]];
        ForegroundInfo_label *foregroundLabel1=[[ForegroundInfo_label alloc]initWithFrame:CGRectMake(50, 0, 100, 20)];
        ForegroundInfo_label *foregroundLabel2=[[ForegroundInfo_label alloc]initWithFrame:CGRectMake(175, 0, 100, 20)];
        ForegroundInfo_label *foregroundLabel3=[[ForegroundInfo_label alloc]initWithFrame:CGRectMake(50, 0, 100, 20)];
        ForegroundInfo_label *foregroundLabel4=[[ForegroundInfo_label alloc]initWithFrame:CGRectMake(175, 0, 100, 20)];
